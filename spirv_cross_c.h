...
typedef enum spvc_resource_type
{
    ...
    SPVC_RESOURCE_TYPE_UNIFORM_CONSTANT = 2,
	SPVC_RESOURCE_TYPE_STORAGE_BUFFER = 3,
	SPVC_RESOURCE_TYPE_STAGE_INPUT = 4,
	SPVC_RESOURCE_TYPE_STAGE_OUTPUT = 5,
	SPVC_RESOURCE_TYPE_SUBPASS_INPUT = 6,
	SPVC_RESOURCE_TYPE_STORAGE_IMAGE = 7,
	SPVC_RESOURCE_TYPE_SAMPLED_IMAGE = 8,
	SPVC_RESOURCE_TYPE_ATOMIC_COUNTER = 9,
	SPVC_RESOURCE_TYPE_PUSH_CONSTANT = 10,
	SPVC_RESOURCE_TYPE_SEPARATE_IMAGE = 11,
	SPVC_RESOURCE_TYPE_SEPARATE_SAMPLERS = 12,
	SPVC_RESOURCE_TYPE_ACCELERATION_STRUCTURE = 13,
	SPVC_RESOURCE_TYPE_RAY_QUERY = 14,
